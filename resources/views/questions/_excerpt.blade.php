<div class="media post">
	...
	<div class="media-body">
		...
		<div class="d-flex align-items-center">
			...
			<div class="ml-auto">
				@if(Auth::user() && Auth::user()->can('update-question', $question) && Auth::user()->can('update', $question))
				<a href="{{ route('questions.edit', $question->id) }}" class="btn btn-sm btn-outline-info">
					Edit
				</a>
				@endif
				
				@if(Auth::user() && Auth::user()->can('delete-question', $question) && Auth::user()->can('delete', $question))
